      ...
      <div className="min-w-max p-6">
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex flex-col items-center justify-center min-w-[200px]">
            ...
            <div className="w-48 h-24 rounded-xl bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border-2 border-yellow-500/30 flex items-center justify-center">
...
function MatchCard({ match, onClick }: MatchCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "w-48 rounded-xl border overflow-hidden transition-all duration-300 cursor-pointer",
