...
export function DreamSection({ maleData, femaleData, leagueData, nextSeason, completedSeason, cmsSections, cmsSettings, onEnterApp, openDonationModal, onVideoPlay }: DreamSectionProps) {
  ...
  return (<>
      ...
      <section id="dream" className="relative py-16 sm:py-28 px-4 overflow-hidden bg-[#0a0a14]">
        {/* Gold dot pattern */}
        ...
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(212,168,83,0.07) 0%, transparent 50%), radial-gradient(ellipse at 20% 70%, rgba(6,182,212,0.03) 0%, transparent 40%), radial-gradient(ellipse at 80% 70%, rgba(168,85,247,0.03) 0%, transparent 40%)' }} />
        {/* Ambient orbs */}
        ...
        >
          ...
          <div className="stagger-item-fast mt-10 grid grid-cols-3 gap-3 sm:gap-4" style={{ animationDelay: '180ms' }}>
            {[
              ...
              <div key={s.label} className={`relative rounded-xl bg-[#0d0d1a] border ${s.accent} p-4 sm:p-5 transition-all duration-300 hover:bg-[#0d0d1a]/80 hover:scale-[1.03] hover:shadow-[0_8px_32px_rgba(212,168,83,0.08)] group/stat`}>
                {/* Subtle radial glow behind icon */}
                <div className="absolute inset-0 rounded-xl pointer-events-none opacity-0 group-hover/stat:opacity-100 transition-opacity duration-500" style={{ background: 'radial-gradient(ellipse at 50% 30%, rgba(212,168,83,0.05), transparent 70%)' }} />
          ...
          {countdown && cmsSettings?.countdown_label && (
            <div className="stagger-item-fast mt-8" style={{ animationDelay: '240ms' }}>
              <div className="rounded-2xl border border-[#d4a853]/20 bg-[#0d0d1a] p-5 sm:p-6 text-center">
                  ...
                  {[
                    ...
                    <div key={unit.label} className="flex items-center gap-1.5 sm:gap-3">
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg sm:rounded-xl bg-[#d4a853]/10 border border-[#d4a853]/20 flex items-center justify-center">
          ...
          <div className="stagger-item-fast mt-8" style={{ animationDelay: '300ms' }}>
            <div className="rounded-2xl border border-[#d4a853]/15 bg-[#0d0d1a] p-5 sm:p-6 text-center">
          ...
          <div className="stagger-item-fast mt-8" style={{ animationDelay: '360ms' }}>
            <button onClick={() => openDonationModal('season')} className="hover-scale-md group/donate relative px-7 py-4 rounded-2xl bg-gradient-to-r from-[#d4a853] to-[#e8d5a3] text-[#0a0a14] font-black text-sm tracking-wider shadow-[0_0_30px_rgba(212,168,83,0.2)] hover:shadow-[0_0_60px_rgba(212,168,83,0.4)] transition-all cursor-pointer overflow-hidden">
      ...
      <section className="relative py-16 sm:py-24 px-4 overflow-hidden bg-[#0a0a14]">
        {/* Gold dot pattern */}
        <div className="absolute inset-0 opacity-[0.012]" style={{ backgroundImage: 'radial-gradient(circle, rgba(212,168,83,0.5) 1px, transparent 1px)', backgroundSize: '24px 24px' }} />
