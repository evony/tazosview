...
const DEFAULT_SKINS = [
  ...
  },
  {
    ...
    description: 'Skin penyawer — kontributor prize pool, makin besar saweran makin prestisius! Berlaku selama 1 minggu',
    icon: '💎',
    colorClass: JSON.stringify(DEFAULT_SKIN_COLORS.sawer),
    priority: 5,
    duration: 'weekly',
    isActive: true,
  },
